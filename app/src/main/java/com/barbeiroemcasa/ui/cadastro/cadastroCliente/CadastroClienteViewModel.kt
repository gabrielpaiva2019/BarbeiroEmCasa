...
class CadastroClienteViewModel(application: Application):
    ...
    private fun salvarDadosFirebase(
        ...
        val firebaseDatabase = FirebaseDatabase.getInstance().getReference("usuarios/clientes/${barbeiroObject.uid}")
